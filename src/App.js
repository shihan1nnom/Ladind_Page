import { Layout, Collapse, Typography, Card, Col, Row, Carousel, Image, Button, Radio } from 'antd';
  ...
  return (
    <div className="App">
      <Layout className="" style={{ background: 'black' }}>
        <Content>
          <div className="Vista-A">
          <Row>
              <Col style={{ marginLeft: '70px' }} span={8}>
                <Title style={{ color: 'white', marginTop: '70px', marginTop: '230px'}}>Introducción</Title>
                <p style={{color: 'white', textShadow: '0px 2px 8px black' }}>
                  En el desarrollo y vida del software se deben tener presentes algunos factores los cuales son muy importantes,
                  estos factores determinan las cualidades que deben proporcionarse en el diseño y la arquitectura de un sistema.
                  En esta Landing Page se busca plasmar los conceptos y principios principales de los siguientes atributos de calidad:
                </p>
                <Button style={{ width: '300px' }}  type="default" shape="round" size="size">
                  <Link to="id_disp" spy={true} smooth={true}>Disponibilidad</Link>
                </Button>
                <br/>
                <Button style={{ marginTop: '5px', width: '300px' }} type="default" shape="round">
                  <Link to="id_inter" spy={true} smooth={true}>Interoperabilidad</Link>
                </Button>
                <br/>
                <Button style={{ marginTop: '5px', width: '300px' }} type="default" shape="round" size="size">
                  <Link to="id_modi" spy={true} smooth={true}>Modificabilidad</Link>
                </Button>
                <br/>
                <Button style={{ marginTop: '5px', width: '300px' }} type="default" shape="round" size="size">
                  <Link to="id_rend" spy={true} smooth={true}>Rendimiento</Link>
                </Button>
                <br/>
                <Button style={{ marginTop: '5px', width: '300px' }} type="default" shape="round" size="size">
                  <Link to="id_seg" spy={true} smooth={true}>Seguridad</Link>
                </Button>
                <br/>
                <Button style={{ marginTop: '5px', width: '300px' }} type="default" shape="round" size="size">
                  <Link to="id_test" spy={true} smooth={true}>Testeabilidad</Link>
                </Button>
              </Col>
              <Col span={15}>
                <Carousel autoplay>
                  <div>
                    <h3 className="Carrusel">
                      <Title style={{ color: 'white', marginTop: '70px'}}>Disponibiidad</Title>
                      <Image
                        className="Imagen-A Shadow-Small"
                        src="./Disponibilidad.jpg"
                      />
                    </h3>
                  </div>
                  <div>
